        ...
        test("functions") {
            clazz.getDeclaredFunctions() shouldContainAll listOf(
                ...
                FunctionDescriptor(
                    "noArgsReturns",
                    emptyList(),
                    FunctionCall::class.parametrizedBy(BigInt::class),
                ),
                FunctionDescriptor(
                    "noArgsMultiReturns",
                    emptyList(),
                ...
                FunctionDescriptor(
                    "get_dy",
                    listOf(
                        ArgDescriptor("i", BigInt::class),
                        ArgDescriptor("j", BigInt::class),
                        ArgDescriptor("dx", BigInt::class),
                    ),
                    ReadFunctionCall::class.parametrizedBy(BigInt::class),
                ),
                FunctionDescriptor(
                    "get_dy_0x5e0d443f",
                    listOf(
